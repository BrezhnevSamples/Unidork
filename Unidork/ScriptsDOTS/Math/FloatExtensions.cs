...
namespace Unidork.DOTS.Math
{
    public static class FloatExtensions
    {
        ...
        public static readonly float2 Float2Down = -Float2Up;
        public static readonly float2 Float2Right = new(1f, 0f);
        public static readonly float2 Float2Left = -Float2Right;
        
        public static readonly float3 Float3Up = new(0f, 1f, 0f);
        public static readonly float3 Float3Down = -Float3Up;
        public static readonly float3 Float3Right = new(1f, 0f, 0f);
        public static readonly float3 Float3Left = -Float3Right;
        public static readonly float3 Float3Forward = new(0f, 0f, 1f);
        public static readonly float3 Float3Back = -Float3Forward;
